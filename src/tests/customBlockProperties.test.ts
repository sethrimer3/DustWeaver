...
describe('Schema version-2 properties', () => {
  test('2. version-2 property definitions save and reload with exact values', () => {
    const props: CustomBlockProperties = { collision: 'oneWay', friction: 'default', breakability: 'indestructible', materialResponse: 'stone', contactDamage: 'none', breakResistance: 'standard', windResponse: 'passThrough' };
