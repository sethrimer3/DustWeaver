...
export function createSnapshot(world: WorldState): WorldSnapshot {
  ...
  for (let i = 0; i < world.clusters.length; i++) {
    ...
    clusterSnapshots.push({
      ...
      isShadowEnemyFlag:c.isShadowEnemyFlag,shadowStartupTicks:c.shadowStartupTicks,shadowRephaseTicks:c.shadowRephaseTicks,shadowVisualPhaseRad:c.shadowVisualPhaseRad,shadowHitFlashTicks:c.shadowHitFlashTicks,
