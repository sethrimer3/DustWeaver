...
export const WORLD1_LEVELS: LevelDef[] = [
  buildWorld1Level(1, 'Stone Crossing', 'physical', [
    { xFraction: 0.72, yFraction: 0.50, kinds: [ParticleKind.Golden], particleCount: 18, isBossFlag: 0 },
  ]),
  buildWorld1Level(2, 'Broken Ramparts', 'physical', [
    { xFraction: 0.55, yFraction: 0.50, kinds: [ParticleKind.Golden], particleCount: 18, isBossFlag: 0 },
    { xFraction: 0.82, yFraction: 0.50, kinds: [ParticleKind.Golden], particleCount: 14, isBossFlag: 0 },
  ]),
  ...
  buildWorld1Level(4, 'Tide Channels', 'water', [
    ...
    { xFraction: 0.78, yFraction: 0.50, kinds: [ParticleKind.Water, ParticleKind.Golden], particleCount: 20, isBossFlag: 0 },
  ]),
  ...
  buildWorld1Level(7, 'Tide Warden (BOSS)', 'boss', [
    {
      xFraction: 0.55,
      yFraction: 0.50,
      kinds: [ParticleKind.Golden, ParticleKind.Water, ParticleKind.Ice],
      particleCount: 40,
      isBossFlag: 1,
    },
  ]),
