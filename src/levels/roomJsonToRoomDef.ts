...
export function roomJsonDefToRoomDef(json: RoomJsonDef): RoomDef {
  ...
  const enemies: RoomEnemyDef[] = json.enemies.map(e => {
    ...
    return {
      ...
      isDustWeaverArchitectFlag: e.isDustWeaverArchitect ? 1 as const : 0 as const,
      isDustWeaverArchitectLargeFlag: e.isDustWeaverArchitectLarge ? 1 as const : 0 as const,
