...
export const ES_CATALOG: Partial<Record<TranslationKey, CatalogEntry>> = {
  ...
  'workshop.update': 'Actualizar',
  'workshop.addByIdPlaceholder': 'ID del elemento (de la URL de su página de Steam)',
  'workshop.statusInstalled': 'Instalado',
  'workshop.statusNotInstalled': 'No descargado',
  'workshop.statusDownloading': 'Descargando…',
  'workshop.statusUpdateAvailable': 'Actualización disponible',

  // ── Diálogo de publicación en Workshop ────────────────────────────────────
  'workshop.publishHeading': 'Publicar campaña en Steam Workshop',
  'workshop.fieldTitle': 'Título',
  'workshop.fieldDescription': 'Descripción',
  'workshop.fieldTags': 'Etiquetas',
  'workshop.fieldTagsPlaceholder': 'separadas por comas, p. ej. puzle, corta, difícil',
  'workshop.fieldVisibility': 'Visibilidad',
  'workshop.fieldPreview': 'Imagen de vista previa (PNG o JPEG, máx. 1 MB)',
  'workshop.fieldItemId': 'ID de elemento existente (déjalo vacío para crear uno nuevo)',
  'workshop.fieldItemIdPlaceholder': 'p. ej. 3012345678',
  'workshop.fieldChangeNote': 'Nota de cambios',
  'workshop.visibilityPublic': 'Público',
  'workshop.visibilityFriends': 'Solo amigos',
  'workshop.visibilityPrivate': 'Privado',
  'workshop.visibilityUnlisted': 'No listado',
  'workshop.publishAction': 'Publicar',
  'workshop.updateAction': 'Actualizar elemento',
  'workshop.statusPreparing': 'Preparando paquete…',
  'workshop.statusUploading': 'Subiendo a Steam…',
  'workshop.statusPublished': 'Publicado correctamente. ID del elemento: {id}',
  'workshop.statusPublishedNeedsAgreement':
    'Subido como elemento {id}, pero permanecerá oculto hasta que aceptes el acuerdo legal de Steam Workshop en su página.',
  'workshop.errorTitleRequired': 'El título es obligatorio.',
  'workshop.errorPreviewTooLarge': 'La vista previa debe ser PNG o JPEG de menos de 1 MB.',
  'workshop.errorPublishFailed': 'Error al publicar: {error}',
