 ...
 *  - 'residentRestore'  — snapshot-restore (honest rename of 'residentHot').
 ...
 */
export type TransitionOutcome = 'residentWorldHot' | 'residentHot' | 'residentRestore' | 'hot' | 'entryWarm' | 'loading' | 'none';
